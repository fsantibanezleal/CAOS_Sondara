...
export default function App() {
  ...
  return <main className="sondara-shell">
    ...
    <footer className="footer"><span>SONDARA · CAOS research project</span><span>Local-first · Apache-2.0 · no login</span><span>v0.1.1 · data never leaves this browser</span></footer>
  </main>;
}
